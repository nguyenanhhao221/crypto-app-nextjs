const Exchanges = () => {
    ...
    //     const dataSource: TExchange[] | undefined = allExchanges?.map(
    //         (exchange) => {
    //             return {
    //                 ...exchange,
    //                 trade_volume_24h_btc: millify(
    //                     Number(exchange.trade_volume_24h_btc)
    //                 ),
    ...
    //                                                     CoinGecko
    //                                                 </a>{' '}
    //                                                 to evaluate the legitimacy of an
    //                                                 exchange’s trading volume. Trust
    //                                                 Score is calculated on a range
    //                                                 of metrics such as liquidity,
    //                                                 scale of operations,
    //                                                 cybersecurity score, and more.
    //                                                 For more details read CoinGecko{' '}
    //                                                 <a
